...
const Sidebar = ({ isSidebarOpen, toggleSidebar }) => {
  return (
    <>
      ...
      ></div>
      <div
        className={`fixed inset-y-0 left-0 bg-white shadow-md transform transition-transform ${
          isSidebarOpen ? "translate-x-0" : "-translate-x-full"
        } w-64 p-6 z-50`}
      >
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-customgreen1">
            Volunteer Connect
          </h2>
        ...
        <nav>
          <Link
            to="/"
            className="flex items-center mb-4 text-gray-700 hover:text-customgreen"
            onClick={toggleSidebar}
          >
            <svg
